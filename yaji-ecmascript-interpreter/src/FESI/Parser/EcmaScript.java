...
public class EcmaScript/* @bgen(jjtree) */implements EcmaScriptTreeConstants,
    ...
    public static void main(String args[]) {
        ...
        if (args.length == 0) {
            System.out
                    .println("FESI EcmaScript Parser:  Reading from standard input . . .");
            parser = new EcmaScript(System.in);
        } else if (args.length == 1) {
            System.out.println("FESI EcmaScript Parser:  Reading from file "
                    + args[0] + " . . .");
            try {
                parser = new EcmaScript(new java.io.FileInputStream(args[0]));
            } catch (java.io.FileNotFoundException e) {
                System.out.println("FESI EcmaScript Parser:  File " + args[0]
                        + " not found.");
                return;
            }
        } else {
        ...
        try {
            ...
            n.jjtAccept(v, null);
            System.out
                    .println("FESI EcmaScript parser:  EcmaScript program parsed successfully.");
        } catch (ParseException e) {
            System.out.println(e.getMessage());
            System.out
                    .println("FESI EcmaScript parser:  Encountered errors during parse.");
        }
    }
    ...
    final public void PrimaryExpression() throws ParseException {
        ...
        case SUPER:
            ...
            try {
                ...
                case THIS:
                    ...
                    break;
                case SUPER:
                    ASTSuperReference jjtn002 = new ASTSuperReference(
                            JJTSUPERREFERENCE);
        ...
        case UNTERMINATED_STRING_LITERAL:
            ...
            break;
        case LPAREN:
            ASTCompositeReference jjtn005 = new ASTCompositeReference(
                    JJTCOMPOSITEREFERENCE);
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x0, 0x200000, 0x0, 0x0, 0x0, 0x280000, 0x0,
                0x1682000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80000, 0x0, 0x0,
                0x1402000, 0x1682000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x7fab800, 0x7fab800, 0x0, 0x0, 0x0, 0x4000, 0x2000000,
                0x1682000, 0x1682000, 0x1682000, 0x1682000, 0x1682000, 0x0,
                0x1682000, 0x0, 0x0, 0x7fbb800, 0x7fbb800, 0x7fab800, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x2bf800, 0x80, 0x22000000, 0x22000000,
                0x22000000, 0x26bf880, 0x22000000, 0x26bf880, 0x0, 0x0,
                0x2000000, 0x0, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x26bf880, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8a6bf880, 0x8a6bf880,
                0x8000000, 0x0, 0x0, 0x0, 0x0, 0x26bf880, 0x26bf880, 0x26bf880,
                0x26bf880, 0x26bf880, 0x0, 0x26bf880, 0x400000, 0x0,
                0x8a6bf880, 0x8a6bf880, 0x8a6bf880, };
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[] { 0x0, 0x0, 0x2, 0x2, 0x2, 0x0, 0x2, 0x78060, 0x1,
                0x2, 0x0, 0x2, 0x0, 0x0, 0x18000, 0x18000, 0x78060, 0x78060,
    ...
    private static void jj_la1_init_3() {
        jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x7f, 0x7f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }
