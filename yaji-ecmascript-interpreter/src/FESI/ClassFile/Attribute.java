...
/**
 * <p>
 * The Attribute class is an abstract base class for all Attribute types found
 * in the Java VM ClassFile format specification. This is a simple
 * implementationd designed to support the minimal functionaliuty required to
 * emit a valid ClassFile stream.
 * </p>
 */
...
abstract class Attribute {
    ...
    protected Attribute(String n, ClassFile cf) {
        UTF8Constant utf8 = (UTF8Constant) cf.match(
                ConstantPoolEntry.CONSTANT_UTF8, n);

        if (utf8 == null)
            utf8 = new UTF8Constant(n, cf);
